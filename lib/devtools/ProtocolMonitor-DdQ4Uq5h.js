...
`}
    ...
    <ul>
      ${eh(o,o=>{let n=a?`${r}.${o.name}`:o.name,i="array"===o.type||"object"===o.type?o.value??[]:[],l=ex(o.type),d="array"===o.type,c=a&&"array"===a.type,p=a&&"object"===a.type,m="object"===o.type,u=void 0===o.value,h=o.optional,g=m&&o.typeRef&&void 0!==t.typesByName.get(o.typeRef),v=o.isKeyEditable,y="string"===o.type||"boolean"===o.type,b=d&&!u&&o.value?.length!==0||m&&!u,f={"optional-parameter":o.optional,parameter:!0,"undefined-parameter":void 0===o.value&&o.optional};return el`
              <li class="row">
                <div class="row-icons">
                    ...
                    ${d?el`
                      ${eE({title:ey(eg.addParameter),iconName:"plus",onClick:()=>t.onAddParameter(n),classMap:{"add-button":!0},jslogContext:"protocol-monitor.add-parameter"})}
                    `:ep}

                    <!-- Render button to complete reset an array parameter or an object parameter-->
                    ${b?eE({title:ey(eg.resetDefaultValue),iconName:"clear",onClick:()=>t.onClearParameter(o,c),classMap:{"clear-button":!0},jslogContext:"protocol-monitor.reset-to-default-value"}):ep}

                    <!-- Render the buttons to change the value from undefined to empty string for optional primitive parameters -->
                    ${l&&!c&&h&&u?el`  ${eE({title:ey(eg.addParameter),iconName:"plus",onClick:()=>t.onAddParameter(n),classMap:{"add-button":!0},jslogContext:"protocol-monitor.add-parameter"})}`:ep}

                    <!-- Render the buttons to change the value from undefined to populate the values inside object with their default values -->
                    ${m&&h&&u&&g?el`  ${eE({title:ey(eg.addParameter),iconName:"plus",onClick:()=>t.onAddParameter(n),classMap:{"add-button":!0},jslogContext:"protocol-monitor.add-parameter"})}`:ep}
                </div>
                ...
                <div class="row-icons">
                    ...
                    <devtools-suggestion-input
                      ...
                      ${eE({title:ey(eg.deleteParameter),iconName:"bin",onClick:()=>t.onDeleteParameter(o,a),classMap:{deleteButton:!0,deleteIcon:!0},jslogContext:"protocol-monitor.delete-parameter"})}`:ep}
                  ...
                  ${l&&!v&&!c&&h&&!u?el`  ${eE({title:ey(eg.resetDefaultValue),iconName:"clear",onClick:()=>t.onClearParameter(o),classMap:{"clear-button":!0},jslogContext:"protocol-monitor.reset-to-default-value"})}`:ep}

                  <!-- If the parameter is an object with no predefined keys, renders a button to add key/value pairs to it's value -->
                  ${m&&!g?el`
                    ${eE({title:ey(eg.addCustomProperty),iconName:"plus",onClick:()=>t.onAddParameter(n),classMap:{"add-button":!0},jslogContext:"protocol-monitor.add-custom-property"})}
                  `:ep}
                  ...
                  ${eE({title:ey(eg.deleteParameter),iconName:"bin",onClick:()=>t.onDeleteParameter(o,a),classMap:{"delete-button":!0},jslogContext:"protocol-monitor.delete-parameter"})}`:ep}
                </div>
              </li>
              ${e(t,i,s,o,n)}
            `})}
        ...
        <devtools-split-view name="protocol-monitor-split-container"
          ...
          <div slot="main" class="vbox protocol-monitor-main">
            <devtools-toolbar class="protocol-monitor-toolbar"
                               jslog=${T("top")}>
               <devtools-button title=${eB(ek.record)}
                    ...
                    ${e.messages.map(t=>{var o;return P`
                      <tr @select=${()=>e.onSelect(t)}
                        ...
                        <td data-value=${t.elapsedTime||0}>
                          ${!("id"in t)?"":t.elapsedTime?eB(ek.sMs,{PH1:String(t.elapsedTime)}):"(pending)"}
                        </td>
                        <td data-value=${t.requestTime}>${eB(ek.sMs,{PH1:String(t.requestTime)})}</td>
            ...
            <devtools-toolbar class="protocol-monitor-bottom-toolbar"
               jslog=${T("bottom")}>
              <devtools-button .title=${e.sidebarVisible?eB(ek.hideCDPCommandEditor):eB(ek.showCDPCommandEditor)}
              ...
              <devtools-toolbar-input id="command-input"
                                      ...
                                      placeholder=${eB(ek.sendRawCDPCommand)}
                                      title=${eB(ek.sendRawCDPCommandExplanation)}
          ...
          <devtools-widget slot="sidebar"
              ...
              ${eA(eP,e=>{t.editorWidget=e})}>
          </devtools-widget>
        </devtools-split-view>`,o)};class eV extends E{started;startTime;messageForId=new Map;filterParser;#_=["method","request","response","target","session"];#W=new eL;#J;#b="";#G=!1;#$;#Y=[];#Z;#Q="";#X;#ee=new Map;constructor(e=eU){super("protocol-monitor",!0),this.#$=e,this.started=!1,this.startTime=0,this.#_=["method","request","response","type","target","session"],this.filterParser=new S(this.#_),this.#J="main",this.performUpdate(),this.#X.addEventListener(eT.SUBMIT_EDITOR,e=>{this.onCommandSend(e.data.command,e.data.parameters,e.data.targetId)}),h.instance().addEventListener(g.AVAILABLE_TARGETS_CHANGED,()=>{this.requestUpdate()}),h.instance().observeTargets(this)}targetAdded(e){this.#ee.set(e.sessionId,e)}targetRemoved(e){this.#ee.delete(e.sessionId)}#et(){let e=this.#X.getCommandJson(),t=this.#X.targetId;t&&(this.#J=t),e&&(this.#b=e,this.requestUpdate())}performUpdate(){let e={messages:this.#Y,selectedMessage:this.#Z,sidebarVisible:this.#G,command:this.#b,commandSuggestions:this.#W.allSuggestions(),filterKeys:this.#_,filter:this.#Q,parseFilter:this.filterParser.parse.bind(this.filterParser),onSplitChange:e=>{if(e)this.#et(),this.#G=!1;else{let{command:e,parameters:t}=eH(this.#b);this.#X.displayCommand(e,t,this.#J),this.#G=!0}this.requestUpdate()},onRecord:e=>{this.setRecording(e)},onClear:()=>{this.#Y=[],this.messageForId.clear(),this.requestUpdate()},onSave:()=>{this.saveAsFile()},onSelect:e=>{this.#Z=e,this.requestUpdate()},onContextMenu:this.#eo.bind(this),onCommandChange:e=>{this.#b=e},onCommandSubmitted:e=>{this.#W.addEntry(e);let{command:t,parameters:o}=eH(e);this.onCommandSend(t,o,this.#J)},onFilterChanged:e=>{this.#Q=e,this.requestUpdate()},onTargetChange:e=>{this.#J=e},onToggleSidebar:()=>{this.#G=!this.#G,this.requestUpdate()},targets:h.instance().targets(),selectedTargetId:this.#J},t=this;this.#$(e,{set editorWidget(value){t.#X=value}},this.contentElement)}#eo(e,t){t.editSection().appendItem(eB(ek.editAndResend),()=>{if(!this.#Z)return;let t=this.#Z.params,o=this.#Z.target?.id()||"",s=e.method;this.#b=JSON.stringify({command:s,parameters:t}),this.#G?this.#X.displayCommand(s,t,o):(this.#G=!0,this.requestUpdate())},{jslogContext:"edit-and-resend",disabled:!("id"in e)}),t.editSection().appendItem(eB(ek.filter),()=>{this.#Q=`method:${e.method}`,this.requestUpdate()},{jslogContext:"filter"}),t.footerSection().appendItem(eB(ek.documentation),()=>{let[t,o]=e.method.split("."),s="id"in e?"method":"event";y.openInNewTab(`https://chromedevtools.github.io/devtools-protocol/tot/${t}#${s}-${o}`)},{jslogContext:"documentation"})}onCommandSend(e,t,o){let s=h.instance(),a=o?s.targetById(o):null,r=a?a.sessionId:"";I.sendRawMessage(e,t,()=>{},r)}wasShown(){super.wasShown(),this.started||(this.started=!0,this.startTime=Date.now(),this.setRecording(!0))}setRecording(e){e?(I.onMessageSent=this.messageSent.bind(this),I.onMessageReceived=this.messageReceived.bind(this)):(I.onMessageSent=null,I.onMessageReceived=null)}messageReceived(e){if("id"in e&&e.id){let t=this.messageForId.get(e.id);if(!t)return;t.result=e.result,t.error=e.error,t.elapsedTime=Date.now()-this.startTime-t.requestTime,this.messageForId.delete(e.id),this.requestUpdate();return}let t=void 0!==e.sessionId?this.#ee.get(e.sessionId):void 0;this.#Y.push({method:e.method,sessionId:e.sessionId,target:t,requestTime:Date.now()-this.startTime,result:e.params}),this.requestUpdate()}messageSent(e){let t=void 0!==e.sessionId?this.#ee.get(e.sessionId):void 0,o={method:e.method,params:e.params,id:e.id,sessionId:e.sessionId,target:t,requestTime:Date.now()-this.startTime};this.#Y.push(o),this.requestUpdate(),this.messageForId.set(e.id,o)}async saveAsFile(){let e="ProtocolMonitor-"+j(new Date)+".json",t=new N;if(!await t.open(e))return;let o=this.#Y.map(e=>({...e,target:e.target?.id()}));t.write(JSON.stringify(o,null,"  ")),t.close()}}class eL{#es=200;#ea=new Set;constructor(e){void 0!==e&&(this.#es=e)}allSuggestions(){let e=[...this.#ea].reverse();return e.push(...eM.keys()),e}buildTextPromptCompletions=async(e,t,o)=>t||o||!e?this.allSuggestions().filter(e=>e.startsWith(t)).map(e=>({text:e})):[];addEntry(e){if(this.#ea.has(e)&&this.#ea.delete(e),this.#ea.add(e),this.#ea.size>this.#es){let e=this.#ea.values().next().value;this.#ea.delete(e)}}}let eF=(e,t,o)=>{w(eN(R,{tabs:[{id:"request",title:eB(ek.request),view:void 0===e.type?new B(eB(ek.noMessageSelected),eB(ek.selectAMessageToView)):D.createViewSync(e.request||null),enabled:"sent"===e.type,selected:"request"===e.selectedTab},{id:"response",title:eB(ek.response),view:void 0===e.type?new B(eB(ek.noMessageSelected),eB(ek.selectAMessageToView)):D.createViewSync(e.response||null),selected:"response"===e.selectedTab}]}),o)};class eK extends m{#$;request;response;type;constructor(e,t=eF){super(e),this.#$=t,this.requestUpdate()}performUpdate(){this.#$({request:this.request,response:this.response,type:this.type,selectedTab:"sent"!==this.type?"response":void 0},void 0,this.contentElement)}}function eH(e){let t=null;try{t=JSON.parse(e)}catch{}return{command:t?t.command||t.method||t.cmd||"":e,parameters:t?.parameters||t?.params||t?.args||t?.arguments||{}}}var ez=Object.freeze({__proto__:null,CommandAutocompleteSuggestionProvider:eL,DEFAULT_VIEW:eU,InfoWidget:eK,ProtocolMonitorImpl:eV,buildProtocolMetadata:eD,parseCommandInput:eH});export{eI as J,ez as P};
